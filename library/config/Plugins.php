 ...
 */
require_once (ASH_PLUGINS . 'class-tgm-plugin-activation.php');
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		//array(
			...
			//'source'   				=> get_template_directory() . '/library/lib/plugins/Aqua-Page-Builder-master.zip', // The plugin source
