...
class ThemeUpdateChecker {
	public $theme = 'Ash';              //The theme associated with this update checker instance.
	public $metadataUrl = 'http://dummyrobot.com/repository/themes/ash/updt.json';   //The URL of the theme's metadata file.
